...
x_tic_base = 4.5
xtic_width = 9
dfile="index_keys_nyc_new.dat"
epsfile="index_keys_nyc_new.eps"
box_width = 3
height=1
...
set ylabel offset 1.1, 0 "# of Keys"   font  'Calibri,33'
set logscale y
set format y "10^{%L}"
...
plot dfile using (($1)-1)*alg_c+x_base:(($3))  title "Before Merging"   with boxes fill pattern 3 lt 1 lw 0.5,\
     dfile using (($1)-1)*alg_c+x_base+box_width:(($4))  title "After Merging" with boxes fill pattern 4 lt 1 lw 0.5