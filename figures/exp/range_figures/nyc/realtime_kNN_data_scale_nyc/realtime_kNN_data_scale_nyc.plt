...
set output "realtime_kNN_data_scale_nyc.eps"
...
set xrange [-0.5:4.5]
set yrange [10:100000]  noreverse nowriteback
...
set xlabel offset 0, 0.5 "Trajectory Data Size (%)" font  'Calibri, 32'
...
plot 'realtime_kNN_data_scale_nyc.dat' using 2 title columnheader (1),  'realtime_kNN_data_scale_nyc.dat' using 3  title columnheader (2)
set output