...
set output "runningtime_breakdown_nyc.eps"
...
set xrange [-0.5:4.5]
set yrange [1:50]  noreverse nowriteback
...
plot 'runningtime_breakdown_nyc.dat' using 2 title columnheader (1),\
'runningtime_breakdown_nyc.dat' using 3  title columnheader (2),\
'runningtime_breakdown_nyc.dat' using 4 title columnheader (3)
set output