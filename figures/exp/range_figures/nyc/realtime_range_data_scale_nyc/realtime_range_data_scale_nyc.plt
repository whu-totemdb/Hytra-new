...
set output "realtime_range_data_scale_nyc.eps"
...
plot 'realtime_range_data_scale_nyc.dat' using 2 title columnheader (1)  with boxes fill pattern 2 lt 1 lw 1,  'realtime_range_data_scale_nyc.dat' using 3  title columnheader (2) with boxes fill pattern 5 lt 1 lw 1
set output