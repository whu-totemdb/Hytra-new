...
set output "historical_range_window_nyc.eps"
...
plot 'historical_range_window_nyc.dat' using 2 title columnheader (1),  'historical_range_window_nyc.dat' using 3  title columnheader (2), 'historical_range_window_nyc.dat' using 4 title columnheader (3)
set output