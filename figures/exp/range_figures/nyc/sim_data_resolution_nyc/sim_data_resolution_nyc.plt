...
set output "sim_data_resolution_nyc.eps"
...
plot 'sim_data_resolution_nyc.dat' using 2 title columnheader (1),  'sim_data_resolution_nyc.dat' using 3  title columnheader (2), 'sim_data_resolution_nyc.dat' using 4 title columnheader (3)
set output