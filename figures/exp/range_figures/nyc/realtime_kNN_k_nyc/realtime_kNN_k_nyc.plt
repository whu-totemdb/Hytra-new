...
set output "realtime_kNN_k_nyc.eps"
...
set xlabel offset 0, 0.5 "k" font  'Calibri-Bold, 32'
...
plot 'realtime_kNN_k_nyc.dat' using 2 title columnheader (1),  'realtime_kNN_k_nyc.dat' using 3  title columnheader (2)
set output