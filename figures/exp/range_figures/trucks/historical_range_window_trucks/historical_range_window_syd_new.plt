...
x_tic_base = 6
xtic_width = 12
dfile="historical_range_window_syd_new.dat"
epsfile="historical_range_window_syd_new.eps"
box_width = 3
height=1
...
plot dfile using (($1)-1)*alg_c+x_base:(($2))  title "Hytra-M"   with boxes fill pattern 4 lt 1 lw 0.5,\
     dfile using (($1)-1)*alg_c+x_base+box_width:(($3))  title "Hytra-NM" with boxes fill pattern 3 lt 1 lw 0.5,\
     dfile using (($1)-1)*alg_c+x_base+2*box_width:(($4))  title "R-tree" with boxes fill pattern 4 lt 1 lw 0.5