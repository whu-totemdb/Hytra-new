...
set output "runningtime_breakdown_syd.eps"
...
plot 'runningtime_breakdown_syd.dat' using 2 title columnheader (1),\
'runningtime_breakdown_syd.dat' using 3  title columnheader (2),\
'runningtime_breakdown_syd.dat' using 4 title columnheader (3)
set output