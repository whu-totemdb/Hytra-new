...
set output "realtime_kNN_data_scale_syd.eps"
...
plot 'realtime_kNN_data_scale_syd.dat' using 2 title columnheader (1),  'realtime_kNN_data_scale_syd.dat' using 3  title columnheader (2)
set output