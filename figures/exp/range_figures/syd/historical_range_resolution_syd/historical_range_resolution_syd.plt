...
set output "historical_range_resolution_syd.eps"
...
set ylabel offset 1.5, 0 "Time Cost (ms)"   font  'Calibri,33' 
...
plot 'historical_range_resolution_syd.dat' using 2 title columnheader (1),  'historical_range_resolution_syd.dat' using 3  title columnheader (2), 'historical_range_resolution_syd.dat' using 4 title columnheader (3)
set output