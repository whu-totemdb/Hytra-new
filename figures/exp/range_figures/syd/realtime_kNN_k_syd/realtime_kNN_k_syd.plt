...
set output "realtime_kNN_k_syd.eps"
...
set xrange [-0.5:4.5]
set yrange [10:20000]  noreverse nowriteback
...
plot 'realtime_kNN_k_syd.dat' using 2 title columnheader (1),  'realtime_kNN_k_syd.dat' using 3  title columnheader (2)
set output