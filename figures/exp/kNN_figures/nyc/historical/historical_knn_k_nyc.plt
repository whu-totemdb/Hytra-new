...
x_tic_base = 6
xtic_width = 12
dfile="historical_knn_k_nyc.dat"
epsfile="historical_knn_k_nyc.eps"
box_width = 3
height=1
...
set xtics font 'Calibri, 30' ( "10" x_tic_base,  "20" x_tic_base+xtic_width, "30" x_tic_base+2*xtic_width, "40" x_tic_base+3*xtic_width, "50" x_tic_base+4*xtic_width)
...
set xlabel offset 0, 0.5 "k" font  'Calibri, 33''
